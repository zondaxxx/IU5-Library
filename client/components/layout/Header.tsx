        ...
        <div className="flex h-16 items-center gap-4">
          <Link to="/" className="flex items-center gap-3">
            ...
            <div className="flex flex-col leading-tight">
              ...
              <span className="text-base font-semibold tracking-tight">Методичка ИУ-5</span>
            </div>
          </Link>
          ...
          <div className="ml-auto flex items-center gap-3">
            <nav className="hidden sm:flex items-center gap-2 rounded-full bg-muted p-1 text-sm">
              <Link to="/" className={cn(
                ...
                location.pathname === "/" ? "bg-background shadow-sm" : "text-muted-foreground hover:text-foreground"
              )}>
                Библио��ека
              </Link>
              <Link to="/favorites" className={cn(
                "rounded-full px-3 py-1.5 transition-colors",
                location.pathname === "/favorites" ? "bg-background shadow-sm" : "text-muted-foreground hover:text-foreground"
              )}>
                Избранное
              </Link>
            </nav>
            ...
            {!isHome && (
              <div className="relative hidden md:block w-72">
                ...
                <Input className="pl-9 rounded-full" placeholder="Поиск материалов" aria-label="Поиск" />
              </div>
            )}
          </div>
        </div>
